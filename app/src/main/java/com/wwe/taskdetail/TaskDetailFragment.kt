...
import com.wwe.R
import com.wwe.databinding.TaskdetailFragBinding
import com.wwe.tasks.DELETE_RESULT_OK
...
class TaskDetailFragment : Fragment() {
    ...
    private val viewModel by viewModels<TaskDetailViewModel> {
        TaskDetailViewModelFactory((requireContext().applicationContext as MyApplication).taskRepository)
    }
